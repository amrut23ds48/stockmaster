...
export const mockReceipts: Receipt[] = [
  {
    ...
    status: 'Completed',
    items: [
      { id: '1', productId: '1', productName: 'Steel Bar 10mm', quantity: 500, unit: 'Pieces' }
    ]
  },
  {
    id: '2',
    ...
    items: [
      { id: '2', productId: '2', productName: 'Steel Plate 6mm', quantity: 1200, unit: 'Kg' }
    ]
  },
  {
    id: '3',
    ...
    status: 'Draft',
    items: [
      { id: '3', productId: '3', productName: 'Angle Iron 50x50', quantity: 150, unit: 'Meter' }
    ]
  },
];
